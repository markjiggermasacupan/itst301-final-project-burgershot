...
<head>
    ...
    <meta property="og:url" content="https://Burgershot.x10.mx/client_account.php"/>
...
<body>
    ...
    <!-- Burger Shot Client Account Page -->
    <main>
        <!-- Burger Shot Client Account -->
