...
<head>
    ...
    <meta name="author" content="Mark Jigger Masacupan">
  	...
  	<meta property="og:title" content="Burger Shot Restaurant | Sign In">
    <meta property="og:url" content="https://Burgershot.x10.mx/signin.php">
...
<body>
    ...
    <!-- Burger Shot Sign Up Page -->
    <main>
        <section class="section_signin">
            <div class="container_signin">
                <div class="container_title">
                    <h1>Sign In to Burger Shot</h1>
